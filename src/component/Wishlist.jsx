    ...
    render() {
        return (
            <div style={{ height: '100vh' }}>
                <div style={{ marginLeft: '460px', marginRight: '350px', marginTop: '60px', marginBottom: '40px', outlineStyle: 'groove', outlineWidth: 'thin', width: '65%' }}>
                    ...
                    {this.state.wishlistBooks.map(book => (
                        <div style={{ marginLeft: '30px', marginTop: '20px', height: '160px', marginBottom: '30px', width: '95%', outlineColor: '#F8F8F8', outlineWidth: 'thin', borderBottom: 'groove', display: 'flex', flexDirection: 'row' }} key={book.id}>
                            ...
                            <div style={{ marginLeft: '50px' }}>
                                ...
                                <h4>Rs. {book.price}</h4>
                                <button style={{ marginLeft: '500px', backgroundColor: '#4863A0', color: 'white', width: '100px', height: '37px', fontWeight: 'bold' }} onClick={() => this.handleChangeBookRemove(book.id)} >Remove</button>
                            </div>
                        </div>
                    ))}
                    </div>
