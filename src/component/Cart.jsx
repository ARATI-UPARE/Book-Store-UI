...
class Cart extends React.Component {
    ...
    render() {
        return (
            <div>
                <NavBar/>
                <div style={{ marginLeft: '350px', marginRight: '350px', marginTop: '30px', marginBottom: '40px', outlineStyle: 'groove', outlineWidth: 'thin' }}><br/>
                        ...
                        {this.state.cartBookList.map(book => (
                            <div style={{ marginLeft: '30px', marginTop: '20px', height: '160px', marginBottom: '30px', width: '95%', outlineColor: '#F8F8F8', outlineWidth: 'thin', borderBottom: 'groove', display: 'flex', flexDirection: 'row' }} key={book.id}>
                                ...
                                <div style={{ marginLeft: '50px', paddingRight: '100px' }}>
                                    ...
                                    <button style={{ marginLeft: '450px', backgroundColor: '#4863A0', color: 'white', width: '150px', height: '37px', fontWeight: 'bold' }} onClick={() => this.handleChangeBookRemove(book.id)}>Remove</button>
                                </div>
                            </div>
                        ))}
                        <button style={{ marginBottom: '9px', marginLeft: '950px', backgroundColor: '#4863A0', color: 'white', width: '220px', height: '40px', fontWeight: 'bold' }} onClick={this.handleChangeEnableCustomerDetails}>Place Order</button>
                    </div>
                </div >
                <div style={{ marginLeft: '350px', marginRight: '350px', marginBottom: '40px', outlineStyle: 'groove', outlineWidth: 'thin' }}>
                    ...
                    {this.state.toggle ?
                        <form>
                            <input style={{ marginLeft: '30px', height: '40px', marginBottom: '10px', width: '700px'  }}maxLength='30' type='text' pattern="/^[a-zA-Z]{3,}$/" placeholder="Name" required></input>
                            ...
                            <br/>
                            <input style={{ marginLeft: '30px', height: '40px', marginBottom: '10px', width: '332px' }} maxLength='6' type='number' pattern="/^[0-9]{6}$/" placeholder="Pincode" required></input>
                            <input style={{ marginLeft: '30px', height: '40px', marginBottom: '10px', width: '332px' }} maxLength='10' type='text' pattern="^[a-zA-Z]{3,}$"placeholder="Locality" required></input><br />
                            <textarea style={{ marginLeft: '30px', height: '50px', marginBottom: '10px', width: '700px' }} maxLength='50' type='text' pattern="/^[a-zA-Z0-9.,-:() ]{5,}$/"placeholder="Address" required></textarea><br />
                            <input style={{ marginLeft: '30px', height: '40px', marginBottom: '10px', width: '332px' }}  type='text' pattern="/^[a-zA-Z ]{3,}$/"placeholder="City/Town" required></input>
                            <input style={{ marginLeft: '30px', height: '40px', marginBottom: '10px', width: '332px' }} type='text' pattern="/^[a-zA-Z ]{3,}$/"placeholder="Landmark" required></input><br />
                            ...
                            <input style={{ marginLeft: '950px', marginBottom: '20px', backgroundColor: '#4863A0', color: 'white', width: '220px', height: '40px', fontWeight: 'bold' }} type="submit" value="CONTINUE" onClick={this.handleChangeEnableOrderSummary}/>
                        </form> : null}
                </div>
                <div style={{ marginLeft: '350px', marginRight: '350px', marginBottom: '40px', outlineStyle: 'groove', outlineWidth: 'thin' }}>
